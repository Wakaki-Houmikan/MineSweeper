...
public class CharaCard{
    ...
    public Text timeLefLab = new Text("余时：");
    public Text stepLefLab = new Text("余步：");
    public Text scoreLab = new Text("得分：");
    public Text missLab = new Text("失误：");
    public Text lifeLab = new Text("生命值：");
     ...
     * @param charaCard 控件组
     */
    public CharaCard(Group charaCard){
        charaCard.getChildren(); //避免IDEA报charaCard没用上
    }
    ...
    void setCardCommon(Group charaCard){
        ...
        robot.setOnAction(event -> Save.charaRed.setRobot(!Save.charaRed.isRobot()));
