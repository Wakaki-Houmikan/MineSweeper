...
/**
 * <strong><big>气候动画  Climate Animation</big></strong>
 *
 * <p>该动画借助TranslateTransition（位移动画）类，控制1200个籽粒以随机的速率从起始点往终止点单向运动，以实现气候效果（下雪、烟雾）。</p>
 *
 * <p>籽粒：边长为6以内随机数的正方形，颜色存在一定扰动。</p>
 *
 * <p>单个籽粒的运动：反复地以均匀速度从起始点直线运动到终止点。技术细节参见其子类的帮助文档。
 * </p>
 *
 * <p>籽粒群：从动画开始运行的一瞬间起，在接下来的一定时间内，每0.1秒新增4个籽粒，并令其进行上述运动，周而复始。</p>
 *
...
public class Climate {
     ...
     * <p>含参建造器：添加气候动画</p>
     *
     * <p>以下以“落雪动画”为例，创建烟雾动画把所有“snow/Snow”改成“smog/Smog”即可</p>
     *
     * <p>基本用法：<br>
     * <code>
     ...
     * 停止所有气候动画
     *
     * <p>令所有正在运动的籽粒的不透明度渐渐降低直至它们淡出，然后将它们删去。</p>
     */
